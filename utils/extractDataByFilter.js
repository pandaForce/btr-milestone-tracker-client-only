...
const extractDataByFilter = (stockdata,params,filtercategory) => {
  ...
  const result = 
    params.length > 3 ? 
      ...
      stockdataFiltered.reduce( (acc, o) => (acc[o[params[0]][params[1]][params[2]]] = ( {sfid: o[params[3]],count: acc[o[params[0]][params[1]][params[2]]] ? acc[o[params[0]][params[1]][params[2]]].count+1: 1,totalprice: acc[o[params[0]]] ? acc[o[params[0]]].totalprice+o.Price__c : o.Price__c, totalsize: acc[o[params[0]]] ? acc[o[params[0]]].totalsize+o.LandSize_r__c : o.LandSize_r__c , totalhousesize : acc[o[params[0]]] ?  (o.LatestMasterContract__c != null ? acc[o[params[0]]].totalhousesize + o.LatestMasterContract__r.HouseDesign__r.TotalSizeInM2__c : 0)  : o.LatestMasterContract__c ? o.LatestMasterContract__r.HouseDesign__r.TotalSizeInM2__c : 0}, console.log(o.HouseDesign__r.TotalSizeInM2__c)) , acc), {}) 
    :  params.length > 2 ? 
      ...
      stockdataFiltered.reduce( (acc, o) => (acc[o[params[0]][params[1]]] = ( {sfid: o[params[2]],count: acc[o[params[0]][params[1]]] ? acc[o[params[0]][params[1]]].count+1: 1,totalprice: acc[o[params[0]]] ? acc[o[params[0]]].totalprice+o.Price__c : o.Price__c,totalsize: acc[o[params[0]]] ? acc[o[params[0]]].totalsize+o.LandSize_r__c : o.LandSize_r__c,  totalhousesize : acc[o[params[0]]] ?  (o.HouseDesign__c ? acc[o[params[0]]].totalhousesize + o.HouseDesign__r.TotalSizeInM2__c : 0)  : o.HouseDesign__c  ? o.HouseDesign__r.TotalSizeInM2__c : 0}) , acc), {}) 
     : filtercategory === 'lot' ? 
    ...
    //  : stockdataFiltered.reduce( (acc, o) => (acc[o[params[0]]] = {sfid: null, count: acc[o[params[0]]] ? acc[o[params[0]]].count+1 : 1, totalprice: acc[o[params[0]]] ? acc[o[params[0]]].totalprice+o.Price__c : o.Price__c,totalsize: acc[o[params[0]]] ? acc[o[params[0]]].totalsize+o.LandSize_r__c : o.LandSize_r__c} , acc), {})
     : stockdataFiltered.reduce( (acc, o) => (
      // console.log('o.LatestMasterContract__r: '+ o.LatestMasterContract__r),
      house_design_size = o.LatestMasterContract__r !== null ? o.LatestMasterContract__r.HouseDesign__r  !== null ? o.LatestMasterContract__r.HouseDesign__r.TotalSizeInM2__c : 0 : 0,
      build_price = o.LatestMasterContract__r !== null ? o.LatestMasterContract__r.BuildContractPrice__c  == 0 ? o.LatestMasterContract__r.PropertyContractPrice__c : o.LatestMasterContract__r.BuildContractPrice__c : 0,
      console.log('build_price: ' + build_price),
      acc[o[params[0]]] = 
        acc[o[params[0]]] ?
        {
          ...
          totalbuildprice: acc[o[params[0]]].totalbuildprice + build_price,
          totalsize: acc[o[params[0]]].totalsize + o.LandSize_r__c ,
          totalhousesize: acc[o[params[0]]].totalhousesize + house_design_size,
          landsettled: o.StatusDevr__c=='Settled' ? acc[o[params[0]]].landsettled+1 : acc[o[params[0]]].landsettled,
          settlementclaimdone: IsFinalCalledUp(o.Milestone__c) ? acc[o[params[0]]].settlementclaimdone + 1: acc[o[params[0]]].settlementclaimdone,
      ...
      }  :
      {
        ...
        totalhousesize: house_design_size,
        totalbuildprice : build_price,
        landsettled: o.StatusDevr__c=='Settled' ? 1 : 0,
        settlementclaimdone: IsFinalCalledUp(o.Milestone__c) ?  1: 0,
    ...
    for (const [key, value] of Object.entries(result)) {
      if (filtercategory === 'lot' ) {
        ...
        tempArray.push({id:key+Math.random()*Math.random(), name: key, count: value.count, sfid: value.sfid, totalprice: value.totalprice, totalbuildprice : value.totalbuildprice, totalsize: value.totalsize, totalhousesize : value.totalhousesize, landsettled: value.landsettled, settlementclaimdone: value.settlementclaimdone, leased: value.leased, completepctg: value.completepctg})
      }
    }
      return tempArray
}
